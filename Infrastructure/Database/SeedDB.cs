    ...
    public static class SeedDB
    {
        public static void SeedAnimals(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bird>().HasData(
                new Bird { Id = Guid.NewGuid(), Name = "Kiwi", TypeOfAnimal = "Bird", animalCanDo = "This animal can fly", CanFly = true, Color = "Green" },
                new Bird { Id = Guid.NewGuid(), Name = "Sunshine", TypeOfAnimal = "Bird", animalCanDo = "This animal can fly", CanFly = true, Color = "Yellow" },
                new Bird { Id = Guid.NewGuid(), Name = "Sky", TypeOfAnimal = "Bird", animalCanDo = "This animal can fly", CanFly = true, Color = "Blue" },
                new Bird { Id = Guid.NewGuid(), Name = "Cherry", TypeOfAnimal = "Bird", animalCanDo = "This animal can fly", CanFly = true, Color = "Red" },
                new Bird { Id = Guid.NewGuid(), Name = "Snowflake", TypeOfAnimal = "Bird", animalCanDo = "This animal can fly", CanFly = true, Color = "White" }
            );
